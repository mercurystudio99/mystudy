...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web', 'admin_locale']], function () use ($prefix) {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'assignments'], function () {
            ...
            Route::get('/{id}/delete', 'LocationController@destroy');
        });

        Route::group(['prefix' => 'session-types'], function () {
            Route::get('/', 'SessionTypeController@index');
            Route::get('/create', 'SessionTypeController@create');
            Route::post('/store', 'SessionTypeController@store');
            Route::get('/{id}/edit', 'SessionTypeController@edit');
            Route::post('/{id}/update', 'SessionTypeController@update');
            Route::get('/{id}/delete', 'SessionTypeController@destroy');
        });
        ...
        Route::group(['prefix' => 'levels'], function () {
            ...
            Route::get('/{id}/edit', 'LevelController@edit');
            Route::post('/{id}/update', 'LevelController@update');
            Route::get('/{id}/delete', 'LevelController@destroy');
        });

        Route::group(['prefix' => 'sublevels'], function () {
            Route::get('/', 'SubLevelController@index');
            Route::get('/create', 'SubLevelController@create');
            Route::post('/store', 'SubLevelController@store');
            Route::get('/{id}/edit', 'SubLevelController@edit');
            Route::post('/{id}/update', 'SubLevelController@update');
            Route::get('/{id}/delete', 'SubLevelController@destroy');
        });
        ...
        Route::group(['prefix' => 'subjects'], function () {
            ...
            Route::get('/{id}/delete', 'SubjectController@destroy');
        });
