...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['check_mobile_app', 'impersonate', 'panel', 'share', 'check_maintenance']], function () {
    ...
    Route::group(['prefix' => 'webinars'], function () {
        ...
        Route::group(['middleware' => 'user.not.access'], function () {
            ...
            Route::post('/getSublevels','WebinarController@getSublevels')->name('webinars.getSublevels');

            Route::post('/getSubjects','WebinarController@getSubjects')->name('webinars.getSubjects');
...
Route::group(['prefix' => 'upcoming_courses'], function () {
    ...
    Route::group(['prefix' => 'tution-chapters'], function () {

        Route::get('/{id}', 'TutionChapterController@getChapter');

        Route::get('/getAllByWebinarId/{webinar_id}', 'TutionChapterController@getAllByWebinarId');

        Route::post('/store', 'TutionChapterController@store');

        Route::post('/{id}/update', 'TutionChapterController@update');

        Route::get('/{id}/delete', 'TutionChapterController@destroy');

        Route::post('/change', 'TutionChapterController@change');
    ...
    Route::group(['prefix' => 'what-to-teach'], function () {

        Route::group(['middleware' => 'user.not.access'], function () {

            Route::get('/', 'WhatYouTeachController@index');

            Route::get('/new', 'WhatYouTeachController@create');

            Route::post('/store', 'WhatYouTeachController@store');

            Route::get('/{id}/step/{step?}', 'WhatYouTeachController@edit');

            Route::get('/{id}/edit', 'WhatYouTeachController@edit');

            Route::post('/{id}/update', 'WhatYouTeachController@update');

            Route::get('/{id}/delete', 'WhatYouTeachController@destroy');

            Route::post('/{id}/getContentItemByLocale', 'WhatYouTeachController@getContentItemByLocale');

            Route::get('/{id}/courses', 'WhatYouTeachController@courses');

            Route::get('/{id}/export-students-list', 'WhatYouTeachController@exportStudentsList');
    ...
    Route::group(['prefix' => 'addresses'], function () {
        ...
        Route::group(['middleware' => 'user.not.access'], function () {
            ...
            Route::get('/{id}/step/{step?}', 'AddressController@edit');
            ...
            Route::post('/{id}/getContentItemByLocale', 'AddressController@getContentItemByLocale');

            Route::get('/{id}/courses', 'AddressController@courses');

            Route::post('/getDistrict', 'AddressController@getDistrict')->name('addresses.getDistrict');

            Route::post('/getLocality', 'AddressController@getLocality')->name('addresses.getLocality');

            Route::post('/getSubLocality', 'AddressController@getSubLocality')->name('addresses.getSubLocality');

            Route::get('/{id}/export-students-list', 'AddressController@exportStudentsList');
