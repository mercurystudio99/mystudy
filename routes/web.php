...
Route::group(['namespace' => 'Web', 'middleware' => ['check_mobile_app', 'impersonate', 'share', 'check_maintenance']], function () {
    ...
    Route::get('/search/sessions', 'HomeController@search')->name('search');
    Route::get('/getSubjects', 'HomeController@getSubjects');
    Route::get('/getDistricts', 'HomeController@getDistricts');
    Route::get('/getLocalities','HomeController@getLocalities');
