        ...
        <table class="table">
            ...
            <tbody>
                @foreach($records as $record)
                    ...
                    <!-- <td>{{@$record->pincode->pin_code}}</td>
                    <td>{{@$record->sublocality->sub_locality}}</td> -->
                    <td>{{@$record->country->locality}}</td>
                    <td>{{@$record->country->district}}</td>
                    <td>{{@$record->country->country}}</td>
                    ...
                    <td class="text-right align-middle">
                        <div class="btn-group dropdown table-actions">
                            ...
                            <div class="dropdown-menu">
                                <a href="/panel/addresses/{{ $record->id }}/edit" class="webinar-actions d-block mt-10 text-hover-primary">{{ trans('public.edit') }}</a>
                                <a href="/panel/addresses/{{ $record->id }}/delete" class="delete-action webinar-actions d-block mt-10 text-hover-primary">{{ trans('public.delete') }}</a>
                            </div>
                        </div>
                    </td>
                </tr>
