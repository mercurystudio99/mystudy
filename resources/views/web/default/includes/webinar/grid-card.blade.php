...
<div class="webinar-card">
    <figure>
        ...
        <figcaption class="webinar-card-body">
            ...
            @if($webinar->subject_title)
                <span class="duration font-14 ml-5">{{ clean($webinar->subject_title,'subject title') }}</span>
            @elseif($subject_title)
                <span class="duration font-14 ml-5">{{ clean($subject_title,'subject title') }}</span>
            @endif
            ...
            <div class="d-flex justify-content-between mt-20">
                <div class="d-flex align-items-center">
                    ...
                    @endphp
                    <span class="duration font-14 ml-5">{{ $hours }} {{ trans('home.hours') }}</span>
                    @endif
