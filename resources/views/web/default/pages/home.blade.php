                ...
                @if($heroSection == "2")
                    <div class="row slider-content align-items-center hero-section2 flex-column-reverse flex-md-row">
                        <div class="col-12 col-md-7 col-lg-6">
                            ...
                            <form action="{{route('search')}}" method="get" class="d-inline-flex mt-30 mt-lg-30 w-100">
                    ...
                    <div class="text-center slider-content mb-2" style="height: 50vh;">
                        ...
                        <div class="row h-100 align-items-center justify-content-center text-center">
                            <div class="col-12 col-md-9 col-lg-7 mb-2">
                                ...
                                <form action="{{route('search')}}" method="get" class="search_row d-inline-flex mt-30 mt-lg-50 p-20" style="margin-left: -8rem!important;width:145%!important">
    ...
    <select id="levelSelect" class="form-control" name="combined_id">
        ...
        @foreach($levels as $level)
            <optgroup label="{{$level->title}}">
                <option value="level_{{$level->id}}" class="level_id">{{$level->title}}</option>
                ...
                <option value="level_{{$level->id}}_sublevel_{{$sublevel->id}}" class="ml-2 sublevel_id">&#9656; {{$sublevel->title}}</option>
                @endforeach
                @endif
            </optgroup>
        @endforeach
        ...
        <div class="dropdown" style="margin-right: auto; padding-left: 10px">
            <select id="countrySelect" class="form-control" name="country">
                ...
                @foreach($countries as $countryTitle)
                    <option value="{{ $countryTitle }}">{{ $countryTitle }}</option>
                @endforeach
