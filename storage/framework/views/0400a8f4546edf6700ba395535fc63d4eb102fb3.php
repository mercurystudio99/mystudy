...
<?php $__env->startSection('content'); ?>
    ...
    <div class="">
        ...
        <form method="post" action="/panel/webinars/<?php echo e(!empty($webinar) ? $webinar->id .'/update' : 'store'); ?>" id="webinarForm" class="webinar-form" enctype="multipart/form-data">
            ...
            <input type="hidden" id="old_session" value="<?php echo e(@$webinar['type']); ?>">
        ...
        <div class="create-webinar-footer d-flex flex-column flex-md-row align-items-center justify-content-between mt-20 pt-15 border-top">
            <div class="d-flex align-items-center">
                ...
                <?php if($webinar->type=='session'): ?>
                    <a href="/panel/webinars/<?php echo e($webinar->id); ?>/step/<?php echo e(($currentStep == 8) ? ($currentStep - 4) : (($currentStep == 4) ? ($currentStep - 3) : ($currentStep - 1))); ?>" class="btn btn-sm btn-primary <?php echo e($currentStep < 2 ? 'disabled' : ''); ?>"><?php echo e(trans('webinars.previous')); ?></a>
                <?php else: ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1c7f25/public_html/resources/views/web/default/panel/webinar/create.blade.php ENDPATH**/ ?>