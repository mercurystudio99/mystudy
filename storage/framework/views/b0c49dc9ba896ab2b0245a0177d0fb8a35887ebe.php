...
<div class="panel-sidebar pt-50 pb-25 px-25" id="panelSidebar">
    ...
    <ul id="panel-sidebar-scroll" class="sidebar-menu pt-10 <?php if(!empty($authUser->userGroup)): ?> has-user-group <?php endif; ?> <?php if(empty($getPanelSidebarSettings) or empty($getPanelSidebarSettings['background'])): ?> without-bottom-image <?php endif; ?>" <?php if((!empty($isRtl) and $isRtl)): ?> data-simplebar-direction="rtl" <?php endif; ?>>
        ...
        <?php if($authUser->isOrganization() or $authUser->isTeacher()): ?>
            <li class="sidenav-item <?php echo e((request()->is('panel/what-to-teach') or request()->is('panel/what-to-teach/*')) ? 'sidenav-item-active' : ''); ?>">
                ...
                <div class="collapse <?php echo e((request()->is('panel/what-to-teach') or request()->is('panel/what-to-teach/*')) ? 'show' : ''); ?>" id="subjectsCollapse">
                    <ul class="sidenav-item-collapse">
                        <li class="mt-5 <?php echo e((request()->is('panel/what-to-teach/new')) ? 'active' : ''); ?>">
                            <a href="/panel/what-to-teach/new"><?php echo e(trans('public.new')); ?></a>
                        </li>

                        <li class="mt-5 <?php echo e((request()->is('panel/subjects')) ? 'active' : ''); ?>">
        ...
        <?php if($authUser->isOrganization() or $authUser->isTeacher()): ?>
            <li class="sidenav-item <?php echo e((request()->is('panel/addresses') or request()->is('panel/addresses/*')) ? 'sidenav-item-active' : ''); ?>">
                ...
                <div class="collapse <?php echo e((request()->is('panel/addresses') or request()->is('panel/addresses/*')) ? 'show' : ''); ?>" id="AddressesCollapse">
                    <ul class="sidenav-item-collapse">
                        <li class="mt-5 <?php echo e((request()->is('panel/addresses/new')) ? 'active' : ''); ?>">
                            <a href="/panel/addresses/new"><?php echo e(trans('public.new')); ?></a>
                        </li>

                        <li class="mt-5 <?php echo e((request()->is('panel/addresses')) ? 'active' : ''); ?>">
...
<?php /**PATH /home/n1c7f25/public_html/resources/views/web/default/panel/includes/sidebar.blade.php ENDPATH**/ ?>