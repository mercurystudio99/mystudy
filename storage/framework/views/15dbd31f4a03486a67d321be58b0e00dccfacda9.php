                ...
                <div class="course-content-body user-select-none">
                    <div class="course-body-on-cover text-white">
                        <h1 class="font-30 course-title">
                            <?php echo e($course->title); ?> <?php if($course->subject_title): ?>(<?php echo e($course->subject_title); ?>)<?php endif; ?>
                        </h1>

                        <!-- <span><?php echo e($course->subject_title); ?></span> -->
                        ...
                        <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                            ...
                            <?php else: ?>
                                <?php
                                    ...
                                    $end_time = new DateTime($course->end_time);
                                    $interval = $start_time->diff($end_time);
                                    $hours = $interval->h + ($interval->days * 24);
                                ?>
                                <span class="font-14"><?php echo e(!empty($hours) ? $hours : 0); ?> <?php echo e(trans('home.hours')); ?></span>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1c7f25/public_html/resources/views/web/default/course/index.blade.php ENDPATH**/ ?>