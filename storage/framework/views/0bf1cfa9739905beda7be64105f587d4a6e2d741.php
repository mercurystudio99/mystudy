...
unset($__errorArgs, $__bag); ?>">
                                                    ...
                                                    <option value="session" <?php if((!empty($webinar) and $webinar->isSession()) or old('type') == \App\Models\Webinar::$session): ?> selected <?php endif; ?>><?php echo e(trans('product.session')); ?></option>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1c7f25/public_html/resources/views/admin/webinars/create.blade.php ENDPATH**/ ?>