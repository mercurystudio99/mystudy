...
<div class="webinar-progress d-block d-lg-flex align-items-center p-15 panel-shadow bg-white rounded-sm">
    ...
    <?php $__currentLoopData = $progressSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="progress-item d-flex align-items-center">
            <button type="button" data-step="<?php echo e($key); ?>" value="<?php echo e($key); ?>" class="js-get-next-step p-0 border-0 progress-icon p-10 d-flex align-items-center justify-content-center rounded-circle <?php echo e($key > 1 && $key < 8 && $key !== 4 ? 'toggle-class' : ''); ?>" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('public.' . $step['name'])); ?>">
...
<?php /**PATH /home/n1c7f25/public_html/resources/views/web/default/panel/webinar/create_includes/progress.blade.php ENDPATH**/ ?>