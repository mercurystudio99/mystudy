                                        ...
                                        <div class="btn-group dropdown table-actions">
                                            ...
                                            <div class="dropdown-menu ">
                                                ...
                                                <?php if($bundle->creator_id == $authUser->id): ?>
                                                    <a href="/panel/bundles/<?php echo e($bundle->id); ?>/delete" class="webinar-actions d-block mt-10 text-danger delete-action"><?php echo e(trans('public.delete')); ?></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    <?php endif; ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1c7f25/public_html/resources/views/web/default/panel/bundle/index.blade.php ENDPATH**/ ?>