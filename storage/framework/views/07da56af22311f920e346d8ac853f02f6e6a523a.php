<?php
$subject_title = DB::table('subjects')->where('id',$webinar->subject_id)->value('title');
?>
<div class="webinar-card">
    <figure>
        ...
        <figcaption class="webinar-card-body">
            ...
            <?php if($webinar->subject_title): ?>
                <span class="duration font-14 ml-5"><?php echo e(clean($webinar->subject_title,'subject title')); ?></span>
            <?php elseif($subject_title): ?>
                <span class="duration font-14 ml-5"><?php echo e(clean($subject_title,'subject title')); ?></span>
            <?php endif; ?>
            ...
            <div class="d-flex justify-content-between mt-20">
                <div class="d-flex align-items-center">
                    ...
                    <?php else: ?>
                    <?php
                    $start_time = new DateTime($webinar->start_time);
                    $end_time = new DateTime($webinar->end_time);
                    $interval = $start_time->diff($end_time);
                    $hours = $interval->h + ($interval->days * 24);
                    ?>
                    <span class="duration font-14 ml-5"><?php echo e($hours); ?> <?php echo e(trans('home.hours')); ?></span>
                    <?php endif; ?>
...
<?php /**PATH /home/n1c7f25/public_html/resources/views/web/default/includes/webinar/grid-card.blade.php ENDPATH**/ ?>