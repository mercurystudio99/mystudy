...
<?php $__env->stopPush(); ?>
<?php
    $combined_id = request()->get('combined_id');
    ...
    if(@$level_id){
        ...
        $getLevel = DB::table('levels')->where('id', $level_id)->value('title');
    }
    if(@$sublevel_id){

        $getSublevel = DB::table('sub_levels')->where('id', $sublevel_id)->value('title');
    }
    if(@$subject_id){

        $getSubject = DB::table('subjects')->where('id',$subject_id)->value('title');
    }
?>
...
<?php if((!empty($webinars) and count($webinars)) or (!empty($products) and count($products)) or (!empty($teachers) and count($teachers)) or (!empty($organizations) and count($organizations))): ?>
                ...
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-12 col-md-9 col-lg-7">
                        <div class="top-search-form">
                            <h1 class="text-white font-30 white-space-pre-wrap"><?php echo e(trans('site.result_find', ['count' => $resultCount])); ?>
        ...
        <div class="container">
            <?php if(!empty($webinars) and count($webinars)): ?>
                <section class="mt-50">
                    <?php if($webinars[0]['type']=='session'): ?>
                        <h2 class="font-24 font-weight-bold text-secondary">Sessions</h2>
                    <?php else: ?>
                ...
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-12 col-md-9 col-lg-7">
                        <div class="d-flex align-items-center flex-column mt-30 text-center w-100">
                            ...
                            <p class="mt-5 text-center white-space-pre-wrap">No result found</p>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1c7f25/public_html/resources/views/web/default/pages/search.blade.php ENDPATH**/ ?>