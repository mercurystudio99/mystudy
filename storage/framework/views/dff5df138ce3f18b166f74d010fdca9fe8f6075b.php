        ...
        <table class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td><img src="<?php echo e(asset('images/' . $record->banner)); ?>" alt="Uploaded Image" id="image-preview" style="width: 50px;"></td>
                    <td><?php echo e(@$record->level->title); ?></td>
                    <td><?php echo e(@$record->sublevel->title); ?></td>
                    <td><?php echo e(@$record->subject->title); ?></td>
                    ...
                    <td class="text-right align-middle">
                        <div class="btn-group dropdown table-actions">
                            ...
                            <div class="dropdown-menu">
                                <a href="/panel/what-to-teach/<?php echo e($record->id); ?>/edit" class="webinar-actions d-block mt-10 text-hover-primary"><?php echo e(trans('public.edit')); ?></a>
                                <a href="/panel/what-to-teach/<?php echo e($record->id); ?>/delete" class="delete-action webinar-actions d-block mt-10 text-hover-primary"><?php echo e(trans('public.delete')); ?></a>
                            </div>
                        </div>
                    </td>
                </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1c7f25/public_html/resources/views/web/default/panel/youTeach/index.blade.php ENDPATH**/ ?>